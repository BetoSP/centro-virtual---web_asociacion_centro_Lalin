...
export default function WhatsAppButton() {
  ...
  useEffect(() => {
    ...
    function handleScroll() {
      ...
      setHidden(delta > 0 && currentScrollY > 0);
  ...
  return (
    <a
      ...
      aria-disabled={!href}
      className={`fixed bottom-6 right-[max(1.5rem,calc((100vw-1180px)/2+1.5rem))] z-40 flex items-center justify-center w-14 h-14 rounded-full shadow-lg transition-transform duration-300 ease-out ${
