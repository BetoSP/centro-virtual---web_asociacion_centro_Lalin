...
2. **Esquema idéntico al acordado** (tablas `asociaciones*` del §6.2/§10.2 de la guía) — **todavía no ejecutado**. Lo que sí se creó y ya está en producción es el esquema propio de formularios (punto 4). Las tablas `asociaciones*` compartidas con el portal quedan para la Fase 3 (migración de contenido real), cuando haya datos reales para cargar.
